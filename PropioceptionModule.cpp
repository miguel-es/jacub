 ...
 public:
     ...
     virtual bool threadInit()
     {
         ...
         //
         Property option("(device cartesiancontrollerleft_arm)");
     ...
     {
         if (s)
             fprintf(stdout,"Body thread started successfully\n");
         else
             fprintf(stdout,"Body thread did not start\n");
     ...
     bool moveLeftArm()
     {
         ...
         left_arm_ctrl->goToPoseSync(xd,od);
...
Generated on Fri May 25 2018 16:09:30 for iCub-main by   doxygen 1.8.13
